...
void Check_word_paren_space(std::string const &mask, int const row, std::vector<Violation> &out);
...
void Check_keyword_position(std::string const &mask, int const row, std::vector<Violation> &out);
...
void Check_angle_close_last(Lines const &mask, Angle_pair const &p, std::vector<Violation> &out);
...
void Check_brace_paren_newline(Lines const &lines, Lines const &mask, std::vector<Violation> &out);
